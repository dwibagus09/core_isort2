...
<link rel="stylesheet" href="/css/magnific-popup.css">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle"><?php echo $this->ident['initial']; ?> - Safety Monthly Analytics</h2>
			<div class="paging">
			...
			?>
				...
				<tr>
				  ...
				  <td class="action-column">
					<?php if($monthlyAnalysis['allowEdit'] == 1) { ?><a href="/default/safety/addmonthlyanalysis/id/<?php echo $monthlyAnalysis['monthly_analysis_id']; ?>" class="action-btn"><i class="fa fa-edit" ></i></a><?php } ?>
					<?php /* <a class="action-btn delete"><i class="fa fa-trash" data-id="<?php $monthlyAnalysis['monthly_analysis_id']; ?>" ></i></a> */ ?>
					<a href="/default/safety/viewdetailmonthlyanalysis/id/<?php echo $monthlyAnalysis['monthly_analysis_id']; ?>" class="action-btn"><img src="/images/view_report2.jpg" width="24" /></a>
					<?php /*<a class="add-comment" href="#comment-form" data-id="<?php echo $monthlyAnalysis['monthly_analysis_id']; ?>" style="float:none; padding-top:10px; display:block;"><img src="/images/comment_24x24.png" /></a>*/ ?>
				  </td>
				</tr>
				<?php
						$i++;
