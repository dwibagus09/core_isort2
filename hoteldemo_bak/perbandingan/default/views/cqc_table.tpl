    ...
    ?>
        ...
        <tr>
            ...
            <?php if(!empty($a['documents'])) { ?>
                ...
                ?>
                    <li><i class="fa fa-paperclip"></i> <a href="<?php echo $this->baseUrl.'/actionplan/'.strtolower(str_replace(" & ", "", $this->category['category_name'])).'/'.substr($doc['uploaded_date'],0,4)."/".$doc['filename']; ?>" target="_blank"><?php if(empty($doc['description'])) echo $doc['filename']; else echo $doc['description']; ?></a></li>
                <?php $i++; } ?>
                </ul>
            <?php } ?>
            </td>
            ...
            if(!empty($a['cqc'])) {
                ...
                <?php if(!empty($cqc['attachment'])) { ?><br/><i class="fa fa-paperclip"></i> <a href="<?php echo $this->baseUrl.'/actionplan/cqc/'.strtolower(str_replace(" & ", "", $this->category['category_name'])).'/'.substr($cqc['uploaded_date'],0,4)."/".$cqc['attachment']; ?>" target="_blank"><?php echo $cqc['attachment']; ?></a><?php } ?>
                </div>						  
                <?php }
            }
            if($a['cqc_approved'] == "1") { ?>
