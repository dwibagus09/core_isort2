			...
			<table id="attachment-table" class="table">
			  ...
			  <div class="form-group">
				<div class="col-md-12" style="text-align:center;">
				  <button id="previous" type="button" class="btn btn-success" style="width:250px;" onclick="javascript:$('body').mLoading();location.href='/default/mod/page2/id/<?php echo $this->mod['mod_report_id']; ?>'">Kembali ke halaman sebelumnya</button>
				</div>
			  </div>
			</form>
		  </div>
