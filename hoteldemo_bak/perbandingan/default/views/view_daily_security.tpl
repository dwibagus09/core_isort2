...
<link rel="stylesheet" href="/css/magnific-popup.css">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle">View Supervisor <?php if($this->securityRole) echo "Security "; ?>Daily Report</h2>
		  ...
		  <table class="table table-striped">
			...
			?>
				...
				<tr>
				  ...
				  <td class="date-column"><?php echo $security['shift_name']; ?></th>
				  <td class="date-column"><?php echo $security['name']; ?></td>
				  <?php /*<td class="briefing-column"><div style="max-height:190px; overflow:auto;"><?php echo nl2br($security['briefing']); ?></div></td>*/ ?>
				  <td>
						<div class="three-newest-comments" id="comment-<?php echo $security['security_id']; ?>">
				  ...
				  <td class="action-column">
					<?php if($this->showEditSecurity == 1 && $security['allowEdit'] == 1 ) {  ?><a href="/default/security/edit/id/<?php echo $security['security_id']; ?>" class="action-btn"><img src="/images/edit_report.png" width="24" /></a><?php } ?>
					<?php /*<a class="action-btn delete"><i class="fa fa-trash" data-id="<?php echo $security['security_id']; ?>" ></i></a>*/ ?>
					<a href="/default/security/viewspvdetailreport/id/<?php echo $security['security_id']; ?>" class="action-btn"><img src="/images/view_report.png" width="24" /></a>
...
$(document).ready(function() {
	...
	$(".fa-trash").click(function() {
		...
		if(res == true)
		{
			location.href="/default/security/delete/id/"+this.dataset.id;
		}
	});
	...
	$('.add-comment').magnificPopup({
		...
		callbacks: {
			...
			close: function() {	
				...
				$.ajax({
                    url: "/default/security/updatecomments",
                    data: { 
                    ...
                    $.each( resp, function( idx, val ) {
                        $( "#comment-"+val['security_id'] ).html(val['comment']);
                    });
                });
			}
		}
		...
		$.ajax({
			...
			success: function(id) {
				$.ajax({
					...
					$("#security_comment_id").val(report_date);
				$( "#comments-content" ).html(response);
	...
	/*setInterval(function(){ 
		$.ajax({
			url: "/default/security/getupdatedcomments",
