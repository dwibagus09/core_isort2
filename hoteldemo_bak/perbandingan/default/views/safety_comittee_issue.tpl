	...
	<div class="meeting-table">
		<table class="table table-striped">
			...
			<tbody>
				...
				<td align="right"><a class="add-comment" href="#comment-form" data-id="<?php echo $issue['issue_id']; ?>" data-site_id="<?php echo $issue['site_id']; ?>"><img src="/images/comment1.png" /></a></td>
				</tr>
				<?php
						$i++;
					}
