	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="x_title">
			<h2 class="page-title">SPV Daily Report</h2>
			...
			<table id="attachment-table" class="table">
			  ...
			  <div class="form-group">
				<div class="col-md-12" style="text-align:center;">
				  <button id="previous" type="button" class="form-btn" style="width:250px;" onclick="javascript:$('body').mLoading();location.href='/default/security/edit/id/<?php echo $this->security['security_id']; ?>'">Back To Previous Page</button>
				</div>
			  </div>
			</form>
		  </div>
...
<!-- Attachment form -->
  <form action="/default/security/addattachment" id="attachment-form" class="mfp-hide white-popup-block"  method="POST" enctype="multipart/form-data">
	...
	<input type="hidden" name="report_id" class="form-control col-md-7 col-xs-12" value="<?php echo $this->security['security_id']; ?>">
...
$(document).ready(function() {
	...
	$(".add-attachment").click(function() {
		...
		if(id > 0)
		{
			...
			$.ajax({
				url: "/default/security/getattachmentbyid",
				data: { id : id }
				...
				{
					$("#attachment_file").html('<a href="/attachment/security/'+obj.upload_date.substring(0, 4)+"/"+obj.filename+'" target="_blank" >'+obj.filename+'</a>');
				}
			});	
		}
		else
	...
	$(".remove-attachment").click(function() {
		...
		if(res == true)
		{
			location.href="/default/security/deleteattachmentbyid/id/"+this.dataset.id+"/report_id/<?php echo $this->security['security_id']; ?>";
		}
	});
