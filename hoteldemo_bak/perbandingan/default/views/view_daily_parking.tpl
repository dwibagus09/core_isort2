...
<link rel="stylesheet" href="/css/magnific-popup.css">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle">Parking &amp; Traffic Daily Report</h2>
			<div class="paging">
		  ...
		  <table class="table table-striped">
			...
			?>
				...
				?>
				<tr>
				  <td class="date-column"><?php echo $parking['day_date']; ?></th>
				  <td class="date-column"><?php echo $parking['name']; ?></td>
				  <td>
						<div class="three-newest-comments" id="comment-<?php echo $parking['parking_report_id']; ?>">
						<?php if(!empty($parking['comments'])) { 
							foreach($parking['comments'] as $comment)
							{
				  ...
				  <td class="action-column">
					<?php if($this->showEditParkingTraffic == 1 && $parking['allowEdit'] == 1) {  ?><a href="/default/parking/edit/id/<?php echo $parking['parking_report_id']; ?>" class="action-btn"><i class="fa fa-edit" ></i></a><?php } ?>
					<?php /* <a class="action-btn delete"><i class="fa fa-trash" data-id="<?php echo $parking['parking_report_id']; ?>" ></i></a> */ ?>
					<a href="/default/parking/viewdetailreport/id/<?php echo $parking['parking_report_id']; ?>" class="action-btn"><img src="/images/view_report2.jpg" width="24" /></a>
					<a class="add-comment" href="#comment-form" data-id="<?php echo $parking['parking_report_id']; ?>"><img src="/images/comment_24x24.png" /></a>
				  </td>
				</tr>
				<?php
						$i++;
...
$(document).ready(function() {
	...
	$(".fa-trash").click(function() {
		...
		if(res == true)
		{
			location.href="/default/parking/deletereport/id/"+this.dataset.id;
		}
	});
	...
	$('.add-comment').magnificPopup({
		...
		callbacks: {
			open: function() {
			  $.ajax({
					url: "/default/parking/getcommentsbyreportid",
					data: { id : id }
			...
			close: function() {	
				...
				$.ajax({
                    url: "/default/parking/updatecomments",
                    data: { 
                    ...
                    $.each( resp, function( idx, val ) {
                        $( "#comment-"+val['parking_report_id'] ).html(val['comment']);
                    });
                });
			}
		}
	...
	/*setInterval(function(){ 
		$.ajax({
			url: "/default/parking/getupdatedcomments",
