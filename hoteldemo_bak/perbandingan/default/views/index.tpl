				  ...
				  <div class="dashboard">						    
					...
					<div class="dashboard-middle">
						<div class="dashboard-xs">
							...
							<?php $avg = 0; foreach($this->issuesAvgDuration as $issuesAvgDuration) { 
								echo '<div class="duration-dashboard"';
								if($avg == 2) echo 'style="margin-left:25%"';
								echo ' ><span style="font-size:16px;">'.$issuesAvgDuration['sitename'] . "</span><br/>". $issuesAvgDuration['duration'] . " days</div>";
							$avg ++; } ?>
						</div>
						<div style="clear:both; width:100%; text-align:center;"><a class="image-popup-vertical-fit" href="/images/sales.jpg" id="dashboard-view-sales-btn">View Sales</a></div>
					</div>
        			<div class="dashboard-small">
...
$(document).ready(function() {
    ...
    <?php if(!empty($this->totalOpenedIssues)) { ?>
    	...
    	<?php $openedIssuesCtr = 0;
			...
			else $totalIssuesHighest = $totalIssuesHighest + (10 - $totalIssuesOff);
    	?>
