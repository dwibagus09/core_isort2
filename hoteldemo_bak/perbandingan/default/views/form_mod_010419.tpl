				  ...
				  <fieldset>
					...
					<table id="inhouse-table" class="table">
						  ...
						  <?php if(!empty($this->utilitySpecificReport)) { 
							...
							<tr>
								<td>
									<?php if(!empty($utilitySpecificReport['picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$utilitySpecificReport['picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$utilitySpecificReport['picture']).'" height="50" style="margin-right:5px; margin-bottom:5px;" /></a>'; ?>
									<?php if(!empty($utilitySpecificReport['solved_picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$utilitySpecificReport['solved_picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$utilitySpecificReport['solved_picture']).'" height="50" /></a>'; ?>
								</td>
				...
				<fieldset>
					...
					<table id="inhouse-table" class="table">
						  ...
						  <tbody>
							...
							<tr>
								<td>
									<?php if(!empty($safetySpecificReport['picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$safetySpecificReport['picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$safetySpecificReport['picture']).'" height="50" style="margin-right:5px;" /></a>'; ?>
									<?php if(!empty($safetySpecificReport['solved_picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$safetySpecificReport['solved_picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$safetySpecificReport['solved_picture']).'" height="50" /></a>'; ?>
								</td>
				...
				<fieldset>
					...
					<table id="inhouse-table" class="table">
						  ...
						  <tbody>
							...
							<tr>
								<td>
									<?php if(!empty($securitySpecificReport['picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$securitySpecificReport['picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$securitySpecificReport['picture']).'" height="50" style="margin-right:5px; margin-bottom:5px;" /></a>'; ?>
									<?php if(!empty($securitySpecificReport['solved_picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$securitySpecificReport['solved_picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$securitySpecificReport['solved_picture']).'" height="50" /></a>'; ?>
								</td>
				...
				<fieldset>
					...
					<table id="inhouse-table" class="table">
						  ...
						  <?php if(!empty($this->hk_progress_report_shift)) { 
							...
							<tr>
								<td>
									<?php if(!empty($hk_progress_report_shift['img_before'])) echo '<a class="image-popup-vertical-fit" href="/images/progress_report/'.$hk_progress_report_shift['img_before'].'"><img src="/images/progress_report/'.$hk_progress_report_shift['img_before'].'" height="50" style="margin-right:5px; margin-bottom:5px;" /></a>'; 
										if(!empty($hk_progress_report_shift['img_progress'])) echo '<a class="image-popup-vertical-fit" href="/images/progress_report/'.$hk_progress_report_shift['img_progress'].'"><img src="/images/progress_report/'.$hk_progress_report_shift['img_progress'].'" height="50" style="margin-right:5px; margin-bottom:5px;" /></a>'; 
										if(!empty($hk_progress_report_shift['img_after'])) echo '<a class="image-popup-vertical-fit" href="/images/progress_report/'.$hk_progress_report_shift['img_after'].'"><img src="/images/progress_report/'.$hk_progress_report_shift['img_after'].'" height="50" style="margin-right:5px; margin-bottom:5px;" /></a>'; 
									?>
								</td>
							...
							<tr>
								<td>
									<?php if(!empty($hk_other_info['img_progress'])) echo '<a class="image-popup-vertical-fit" href="/images/progress_report/'.$hk_other_info['img_progress'].'"><img src="/images/progress_report/'.$hk_other_info['img_progress'].'" height="50" style="margin-right:5px;" /></a>';	?>
								</td>
				...
				<fieldset>
					...
					<table id="inhouse-table" class="table">
						  ...
						  <?php if(!empty($this->parkingSpecificReport)) { 
							...
							<tr>
								<td>
									<?php if(!empty($parkingSpecificReport['picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$parkingSpecificReport['picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$parkingSpecificReport['picture']).'" height="50" style="margin-right:5px; margin-bottom:5px;" /></a>'; ?>
									<?php if(!empty($parkingSpecificReport['solved_picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$parkingSpecificReport['solved_picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$parkingSpecificReport['solved_picture']).'" height="50" /></a>'; ?>
								</td>
			  ...
			  <span class="section">Jumlah Kendaraan Masuk</span>	
				 <table id="head-car-count" class="table">
					...
					<tr>
						...
						<td><input type="text" name="car_parking" class="form-control col-md-7 col-xs-12" value="<?php echo $this->mod['car_parking']; ?>" required></td>
					</tr>
					<tr>
						<td>Car Count Drop Off</td>
						<td><input type="text" name="car_drop_off" class="form-control col-md-7 col-xs-12" value="<?php echo $this->mod['car_drop_off']; ?>" required></td>
					</tr>
					<tr>
						<td>Box Vehicle</td>
						<td><input type="text" name="box_vehicle" class="form-control col-md-7 col-xs-12" value="<?php echo $this->mod['box_vehicle']; ?>" required></td>
					</tr>
					<tr>
						<td>Motorbike</td>
						<td><input type="text" name="motorbike" class="form-control col-md-7 col-xs-12" value="<?php echo $this->mod['motorbike']; ?>" required></td>
					</tr>
					<tr>
						<td>Bus</td>
					...
					<tr>
						<td>Valet Service</td>
						<td><input type="text" name="valet_parking" class="form-control col-md-7 col-xs-12" value="<?php echo $this->mod['valet_parking']; ?>" required></td>
					</tr>
					
					<tr>
						<td>Taxi Bluebird</td>
						<td><input type="text" name="taxi_bluebird" class="form-control col-md-7 col-xs-12" value="<?php echo $this->mod['taxi_bluebird']; ?>" required></td>
					</tr>
					<tr>
					  ...
					  <tbody>
						...
						?>
							<tr>
								...
								<td align="center">
									<?php if(!empty($incident['picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$incident['picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$incident['picture']).'" height="50" style="margin-right:5px; margin-bottom:5px;" /></a>'; ?>
									<?php if(!empty($incident['solved_picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$incident['solved_picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$incident['solved_picture']).'" height="50" /></a>'; ?>
								</td>
					  ...
					  <tbody>
						<?php if(!empty($this->lostFound)) {
							...
							<tr>
								...
								<td align="center">
									<?php if(!empty($lostFound['picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$lostFound['picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$lostFound['picture']).'" height="50" style="margin-right:5px; margin-bottom:5px;" /></a>'; ?>
									<?php if(!empty($lostFound['solved_picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$lostFound['solved_picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$lostFound['solved_picture']).'" height="50" /></a>'; ?>
								</td>
					  ...
					  <tbody>
						<?php if(!empty($this->glitch)) {
							...
							<tr>
								...
								<td align="center">
									<?php if(!empty($glitch['picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$glitch['picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$glitch['picture']).'" height="50" style="margin-right:5px; margin-bottom:5px;" /></a>'; ?>
									<?php if(!empty($glitch['solved_picture'])) echo '<a class="image-popup-vertical-fit" href="/images/issues/'.str_replace(".","_large.",$glitch['solved_picture']).'"><img src="/images/issues/'.str_replace(".","_thumb.",$glitch['solved_picture']).'" height="50" /></a>'; ?>
								</td>
