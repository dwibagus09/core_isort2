  ...
  <div class="detail-report">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  <div class="x_title">
			<h2>PARKING MONTHLY ANALYSIS REPORT - <?php echo $this->monthYear; ?></h2>
			<div class="clearfix"></div>			
			<a href="/default/parking/downloadparkingmonthlyanalysis/id/<?php echo $this->monthly_analysis_id; ?>" target="_blank" style="float:right;"><img src="/images/newlogo_pdf.png" width="24"></a>
		  ...
		  <div class="x_content">
			...
			<span class="section">DETAIL KEJADIAN BULAN <?php echo strtoupper($this->monthYear); ?></span>
			<div class="table-dv">
			<table id="perlengkapan-table" class="table">
			  <thead>
				<tr>
			...
			<span class="section" style="clear:both; padding-top:20px;">JENIS KEJADIAN YANG SERING TERJADI BERDASARKAN JUMLAH KASUS BULAN <?php echo strtoupper($this->monthYear); ?></span>
			<div class="table-dv">
