    ...
    ?>
        <tr <?php if($i%2==0) echo 'class="even-row"'; ?>>
            <td width="20"><?php echo $issue['issue_id']; ?>
				<?php if($this->category_id == 6 && $issue['solved'] == 0  && $this->addWorkOrder == 1 && $issue['show_add_wo_btn'] == 1) { ?><br/><a id="wo<?php echo $issue['issue_id']; ?>" class="add-wo" href="#wo-form" data-id="<?php echo $issue['issue_id']; ?>"><img src="/images/wo.png" alt="Create Work Order"/>Work Order</a><?php }
				elseif($this->category_id != 6  && $issue['solved'] == 0) {
			?>
				<br/>
