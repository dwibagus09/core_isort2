  ...
  <div class="detail-report">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  <div class="x_title">
			<h2 class="pagetitle">MONTHLY KPI - <?php echo $this->selectedYear; ?></h2>
...
$(document).ready(function() {
	...
	monthlyKPIDataChart.setLineColor("#a1a2a6", 'green');
	monthlyKPIDataChart.setLineColor("#e1cb95", 'yellow');
