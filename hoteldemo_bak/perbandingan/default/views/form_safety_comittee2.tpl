				...
				<div class="x_content">
					...
					<div class="form-group">
						<div class="col-md-12" style="text-align:center;">
							<button id="send" type="button" class="form-btn" style="width:250px;" onclick="javascript:$('body').mLoading();location.href='/default/safetycomittee/edit/id/<?php echo $this->safetyComittee['safety_comittee_id']; ?>'">Back to previous page</button>
						</div>
					</div>
				</div>
			</form>
...
<form action="/default/safetycomittee/savetopic" id="topic-form" class="mfp-hide white-popup-block" method="post" enctype="multipart/form-data" >
	...
	<div class="add-btn"><input type="submit" id="add-topic-submit" name="add-topic-submit" value="Save" class="form-btn"></div>
</form>
