...
<link rel="stylesheet" href="/css/magnific-popup.css">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle">IT Meeting Issues / Projects History</h2>

			<div class="filter">
				<form id="filter-form" action="/default/it/history"  method="post">
					<div class="filter-field">Filter by User: 
						<select id="pic-select" name="pic_id" style="width:120px; padding:3px;">
							<option value="0">All</option>
							<?php foreach($this->users as $user) { ?>
							<option value="<?php echo $user['user_id']; ?>" <?php if($user['user_id'] == $this->pic_id) echo "selected"; ?>><?php echo $user['name']; ?></option>
							<?php } ?>
						</select>
					</div>
