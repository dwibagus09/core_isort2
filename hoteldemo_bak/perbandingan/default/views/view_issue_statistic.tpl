...
/*** KAIZEN PER TYPE GRAPH ***/
	...
	/*** PARKING & TRAFFIC TOTAL KAIZEN GRAPH ***/
	...
	parkingTotalIssueChart.setTitle('TOTAL KAIZEN');
	...
	/*** PARKING & TRAFFIC KAIZEN PER TYPE GRAPH ***/
	...
	parkingIssuePerTypeChart.setTitle('TOTAL KAIZEN PER TYPE');
	...
	/*** PARKING & TRAFFIC OPEN & CLOSE KAIZEN PER CATEGORY ***/
	...
	$("#export-issue-stat").click(function() {
		...
		var park_total_issue = document.getElementById("parking-total-issue");
		var park_type_issue = document.getElementById("parking-type-issue");
		var park_open_close = document.getElementById("parking-open-close");
		var park_weekend = document.getElementById("parking-weekend");
