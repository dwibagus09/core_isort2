...
<link rel="stylesheet" href="/css/magnific-popup.css">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle"><?php echo $this->ident['initial']; ?> - Parking &amp; Traffic Monthly Analysis</h2>
			<div class="paging">
			...
			?>
				...
				<tr>
				  ...
				  <td class="action-column">
					<?php if($monthlyAnalysis['allowEdit'] == 1) { ?><a href="/default/parking/addmonthlyanalysis/id/<?php echo $monthlyAnalysis['monthly_analysis_id']; ?>" class="action-btn"><i class="fa fa-edit" ></i></a><?php } ?>
					<?php /* <a class="action-btn delete"><i class="fa fa-trash" data-id="<?php echo $mod['mod_report_id']; ?>" ></i></a> */ ?>
					<a href="/default/parking/viewdetailmonthlyanalysis/id/<?php echo $monthlyAnalysis['monthly_analysis_id']; ?>" class="action-btn"><img src="/images/view_report2.jpg" width="24" /></a>
