	  ...
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="x_content">
			...
			<form id="housekeeping-form" class="form-horizontal form-label-left" action="/default/housekeeping/savereport" method="POST" onsubmit="$('body').mLoading();">
...
$(document).ready(function() {
	...
	$('#housekeeping-form').on('submit', function(event){
		$("body").mLoading();
	});
});	
</script>