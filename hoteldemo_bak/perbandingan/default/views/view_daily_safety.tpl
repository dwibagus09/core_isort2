...
<link rel="stylesheet" href="/css/magnific-popup.css">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle">Safety Daily Report</h2>
			<div class="paging">
		  ...
		  <table class="table table-striped">
			...
			?>
				...
				?>
				<tr>
				  <td class="date-column"><?php echo $safety['day_date']; ?></th>
				  <td class="date-column"><?php echo $safety['name']; ?></td>
				  <td>
						<div class="three-newest-comments" id="comment-<?php echo $safety['report_id']; ?>">
						<?php if(!empty($safety['comments'])) { 
							foreach($safety['comments'] as $comment)
							{
				  ...
				  <td class="action-column">
					<?php if($this->showEditSafety == 1 && $safety['allowEdit'] == 1) {  ?><a href="/default/safety/edit/id/<?php echo $safety['report_id']; ?>" class="action-btn"><i class="fa fa-edit" ></i></a><?php } ?>
					<?php /*<a class="action-btn delete"><i class="fa fa-trash" data-id="<?php echo $safety['report_id']; ?>" ></i></a> */ ?>
					<a href="/default/safety/viewdetailreport/id/<?php echo $safety['report_id']; ?>" class="action-btn"><img src="/images/view_report2.jpg" width="24" /></a>
					<a class="add-comment" href="#comment-form" data-id="<?php echo $safety['report_id']; ?>"><img src="/images/comment_24x24.png" /></a>
				  </td>
				</tr>
				<?php
						$i++;
...
$(document).ready(function() {
	...
	$(".fa-trash").click(function() {
		...
		if(res == true)
		{
			location.href="/default/safety/delete/id/"+this.dataset.id;
		}
	});
	...
	$('.add-comment').magnificPopup({
		...
		callbacks: {
			open: function() {
			  $.ajax({
					url: "/default/safety/getsafetycommentsbyreportid",
					data: { id : report_id }
			...
			close: function() {	
				...
				$.ajax({
                    url: "/default/safety/updatecomments",
                    data: { 
	...
	/*setInterval(function(){ 
		$.ajax({
			url: "/default/safety/getupdatedcomments",
