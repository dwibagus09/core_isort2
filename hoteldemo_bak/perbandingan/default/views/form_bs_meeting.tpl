	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <form class="form-label-left" action="/default/bs/save" method="POST" onsubmit="$('body').mLoading();">
		  	<input id="bs_meeting_id" name="bs_meeting_id" type="hidden" value="<?php echo $this->bsMeeting['bs_meeting_id']; ?>">
			<div class="x_title">
			...
			<div class="x_content">
				<div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input id="title" class="form-control col-md-7 col-xs-12" name="title" type="text" value="<?php echo $this->bsMeeting['meeting_title']; ?>" required>
					</div>
				</div>
				<br/>
				<div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input id="meeting_date" class="form-control col-md-7 col-xs-12 datepicker" name="meeting_date" type="text" value="<?php echo $this->bsMeeting['tanggal']; ?>" required autocomplete="off">
					</div>
				</div>
				<br/>
				<div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input id="meeting_time" class="form-control col-md-7 col-xs-12" name="meeting_time" type="text" value="<?php echo $this->bsMeeting['meeting_time']; ?>" required>
					</div>
				</div>
				<br/>
				<div class="item form-group">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<table id="attendance-table" class="table table-striped">
							...
							<?php if(!empty($this->attendance)) {
								...
								{ ?>
									<tr>
										<td><select id="site-select" name="attendance_site_id[]"  class="form-control col-md-7 col-xs-12" required>
												<option value="" disabled selected hidden>Select Site</option>
												<?php foreach($this->sites as $site) { ?>
												<option value="<?php echo $site['site_id']; ?>" <?php if($attendance['site_id'] == $site['site_id']) echo "selected"; ?>><?php echo $site['initial']; ?></option>
												<?php } ?>
											</select>
										</td>
	...
	$(".remove-attendance").click(function() {
		...
		if(this.dataset.id > 0)
		{
			...
			if(res == true)
			{
				$("body").mLoading();			
				$.ajax({
					url: "/default/bs/deleteattendancebyid",
