...
class PivotController extends actionControllerBase
{
	...
	{	
		if($this->showSecurityPivotChart || $this->showSafetyPivotChart || $this->showParkingPivotChart || $this->showHousekeepingPivotChart)
		{
			...
			$this->view->floor = $allFloors = $floorClass->getFloorByCategoryId($params['c']);
			...
			$this->view->totalEachArea = $floorClass->getTotalEachModus($params['c'], $year, $months, $days, $period, $floors, $tenant_umum, $issuetypes, $incidents, $modus, $this->site_id);
	...
	function exportpivottopdfAction() {
		if($this->showSecurityPivotChart || $this->showSafetyPivotChart || $this->showParkingPivotChart)
		{
			...
			$pdf->Image($this->config->paths->html."/stat/".'totalAllChart_'.$params['pf'].'_'.$curdate.'.png',0,35,0,40);	
			$pdf->Image($this->config->paths->html."/stat/".'totalDayChart_'.$params['pf'].'_'.$curdate.'.png',70,35,0,47);	
			$pdf->Image($this->config->paths->html."/stat/".'totalEachIssueType_'.$params['pf'].'_'.$curdate.'.png',5,85,0,40);	
			$pdf->Image($this->config->paths->html."/stat/".'totalMonthlyChart_'.$params['pf'].'_'.$curdate.'.png',100,85,0,45);
			$pdf->Image($this->config->paths->html."/stat/".'totalEachPeriod_'.$params['pf'].'_'.$curdate.'.png',5,140,0,45);
			$pdf->Image($this->config->paths->html."/stat/".'totalEachArea_'.$params['pf'].'_'.$curdate.'.png',100,140,0,47);
			$pdf->Image($this->config->paths->html."/stat/".'totalEachIncident_'.$params['pf'].'_'.$curdate.'.png',5,205,0,47);
			$pdf->Image($this->config->paths->html."/stat/".'totalEachModus_'.$params['pf'].'_'.$curdate.'.png',100,205,0,47);
	...
	{	
		if($this->showCorporateSecurityPivotChart || $this->showCorporateSafetyPivotChart || $this->showCorporateParkingPivotChart)
		{
			...
			$this->view->floor = $allFloors = $floorClass->getFloorByCategoryIdAndSites($params['c'], $site_id);
			...
			$this->view->totalEachArea = $floorClass->getTotalEachModus($params['c'], $year, $months, $days, $period, $floors, $tenant_umum, $issuetypes, $incidents, $modus, $site_id);
	...
	function exportcorporatepivottopdfAction() {
		if($this->showCorporateSecurityPivotChart || $this->showCorporateSafetyPivotChart || $this->showCorporateParkingPivotChart)
		{
			...
			$pdf->Image($this->config->paths->html."/stat/".'totalDayChart_corp_'.$params['c'].'_'.$curdate.'.png',90,35,0,47);	
			$pdf->Image($this->config->paths->html."/stat/".'totalEachType_corp_'.$params['c'].'_'.$curdate.'.png',5,85,0,40);
			$pdf->Image($this->config->paths->html."/stat/".'totalMonthlyChart_corp_'.$params['c'].'_'.$curdate.'.png',100,85,0,45);
			$pdf->Image($this->config->paths->html."/stat/".'totalEachPeriod_corp_'.$params['c'].'_'.$curdate.'.png',5,140,0,45);
			$pdf->Image($this->config->paths->html."/stat/".'totalEachArea_corp_'.$params['c'].'_'.$curdate.'.png',100,140,0,47);
			$pdf->Image($this->config->paths->html."/stat/".'totalEachIncident_corp_'.$params['c'].'_'.$curdate.'.png',5,205,0,47);
			$pdf->Image($this->config->paths->html."/stat/".'totalEachModus_corp_'.$params['c'].'_'.$curdate.'.png',100,205,0,47);
