		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div style="margin-bottom:10px;">
				...
				<div id="bar-graph">
					...
					<img id="exporttopdf" src="/images/newlogo_pdf.png" width="24" class="exportaptopdf" />
				</div>
...
var calendar = new FullCalendar.Calendar(calendarEl, {
  ...
  headerToolbar: {
        left: 'title addSchedule today dayGridMonth,timeGridWeek,listMonth prev,next',
        center: '',
        right: ''
  },
  /*views: {
  ...
  ?>
	{
	  ...
	  <?php if($schedule['status'] == 1) echo "color: '#a1a2a6'"; else if($schedule['status'] == 2) echo "color: 'darkorange'"; ?>
	},
  <?php } ?>
  ],
