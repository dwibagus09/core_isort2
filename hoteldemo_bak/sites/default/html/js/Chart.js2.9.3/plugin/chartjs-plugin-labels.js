...
(function () {
  ...
  var SUPPORTED_TYPES = {};
  ['pie', 'doughnut', 'polarArea', 'bar', 'line', 'horizontalBar'].forEach(function (t) {
  ...
  Label.prototype.setup = function (chart, options) {
    ...
    if (chart.config.type === 'bar' || chart.config.type === 'line' || chart.config.type === 'horizontalBar') {
  ...
  Label.prototype.getPercentage = function (dataset, element, index) {
    ...
    } else if (this.chart.config.type === 'bar' || this.chart.config.type === 'line' || this.chart.config.type === 'horizontalBar') {
    ...
    if (!this.options.showActualPercentages) {
      if (this.chart.config.type === 'bar' || this.chart.config.type === 'line' || this.chart.config.type === 'horizontalBar') {
  ...
  Label.prototype.getRenderInfo = function (element, label) {
    if (this.chart.config.type === 'bar' || this.chart.config.type === 'line') {
      return this.getBarRenderInfo(element, label);
    } else if(this.chart.config.type === 'horizontalBar'){
		return this.getHorizontalBarRenderInfo(element, label);
	} else {
  ...
  Label.prototype.getHorizontalBarRenderInfo = function (element, label) {
    var renderInfo = element.tooltipPosition();
    renderInfo.x += this.measureLabel(label).height / 2 + this.options.textMargin;
    return renderInfo;
  };
