		...
		<div id="list-issue-desktop">
			<div id="issue-tabs" class="tabs">
				    ...
				    <ul class="nav nav-tabs process-model more-icon-process" role="tablist" id="tabs-aktif">
						...
						<?php if($this->site_id == 2) { ?>
							...
							<?php if($this->showParkingIssues == 1) { ?>
							  <li role="presentation"><a id="parkingicon" href="#safety" aria-controls="safety" role="tab" data-toggle="tab" data-id="5"><img src="/images/safety_silver.png" />
				...
				<div class="filter">
					...
					<?php
						if($this->wo == 1){					
						echo 'wo <div id="wopdf" style="display:none;" class="filter-field"><img id="exporttopdfwo" class="exporttopdf-btn" src="/images/newlogo_pdf.png"></div>';
						} else{
						echo '<div class="filter-field"><img id="exporttopdf" class="exporttopdf-btn" src="/images/newlogo_pdf.png"></div>';
						} ?>
					</form>
				</div>
				<div class="content">
...
$(document).ready(function() {
	...
	$("#exporttopdf").click(function() {
		...
		var url = '/default/issue/newexportissuestopdf/solved/1/id/'+tabId;
		if($('#issue_id').val() > 0)
		{
