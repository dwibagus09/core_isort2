...
<style>
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle">Checklist Watertank</h2>
		  ...
		  <table class="table">
			...
			?>
				...
				?>
				  ...
				  <td class="date-column"><?php echo $checklist['shift']; ?></td>
				 <td>
				  ...
				  <td class="action-column">
					...
					<a href="/default/checklistwatertank/viewupdatedetail/id/<?php echo $checklist['checklist_watertank_id']; ?>" class="menu_<?php echo $menuClass; ?>"><img src="/images/edit_report.png" width="24" /></a>
					<a href="/default/checklistwatertank/viewdetail/is/<?php echo $checklist['checklist_watertank_id']; ?>" class="action-btn"><img src="/images/view_report.png" width="24" /></a>
					<a class="add-comment" href="#comment-form" data-id="<?php echo $checklist['checklist_watertank_id']; ?>" style="float:none; padding-top:10px;"><img src="/images/comment1.png" /></a> 
				  	</td>
				</tr>
				<?php
						$i++;
