  ...
  <div class="">
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div >
		<div class="x_title">
				<h2 class="page-title">Detail Watertank Checklist</h2>
				<div class="clearfix"></div>
			</div>
		<form action="/default/checklistwatertank/registerwater2" method="POST" onsubmit="$('body').mLoading();">
		<fieldset>
			<legend>Pump Room:</legend>
			<label for="fname">Shift:</label>
			<select type="select" id="shift" name="shift" disabled>
			...
			<input type="text" id="tempcool" name="tempcool" value="<?php echo $this->checklist['temper_cool']; ?>" disabled><br><br>
			<label for="temphot">Temp Hot (&#8451;):</label>
			<input type="text" id="temphot" name="temphot"  value="<?php echo $this->checklist['temper_hot']; ?>" disabled><br><br>
			<label for="Vol1">Volume 1 (%):</label>
			<input type="text" id="vol1" name="vol1" value="<?php echo $this->checklist['vol_1']; ?>" disabled><br><br>
			<label for="Vol2">Volume 2 (%):</label>
			<input type="text" id="vol2" name="vol2" value="<?php echo $this->checklist['vol_2']; ?>" disabled><br><br>
		</fieldset>
		<fieldset>
			<legend>Swimming Pool:</legend>
			<label for="PH">PH:</label>
			<input type="text" id="ph" name="ph" value="<?php echo $this->checklist['ph']; ?>" disabled><br><br>
			<label for="CL">CL:</label>
			<input type="text" id="cl" name="cl" value="<?php echo $this->checklist['cl']; ?>" disabled><br><br>
			<label for="Vol1">P Sampit Utara:</label>
			<select type="text" id="psu" name="psu" disabled>
			...
			<select  id="pss1" name="pss1" disabled>
			...
			<select  id="pss2" name="pss2" disabled>
			...
			<select  id="pss3" name="pss3" disabled>
			...
			<select  id="psk" name="psk" disabled>
			...
			<input type="text" id="genzet1" name="genzet1" value="<?php echo $this->checklist['genzet_1'];?>" disabled><br><br>
			<label for="Vol2">Genzet 2:</label>
			<input type="text" id="genzet2" name="genzet2" value="<?php echo $this->checklist['genzet_2'];?>" disabled><br><br>
			<label for="Vol2">Fuel 1 (%):</label>
			<input type="text" id="fuel1" name="fuel1" value="<?php echo $this->checklist['fuel_1'];?>" disabled>
			<br><br>
			<label for="Vol2">Fuel 2 (%):</label>
			<input type="text" id="fuel2" name="fuel2" value="<?php echo $this->checklist['fuel_2'];?>" disabled>
			<br><br>
			<label for="Vol2">Remarks:</label>
			<textarea type="text" id="remark" name="remark" value="<?php echo $this->checklist['remarks'];?>" disabled><?php echo $this->checklist['remarks'];?></textarea>
			<br><br>
		</fieldset>
		</form>
		</div> 
