...
border-radius: 100%;
  ...
  <div class="">
    ...
    <div class="alert-message">
        <?php echo $this->escapeHtml($alertMessage); ?>
    </div>
<?php endif; ?>
		<div class="x_title">
		...
		<fieldset>
			...
			<input type="number" id="tempcool" name="tempcool"><br><br>
			<label for="temphot">Temp Hot (&#8451;):</label>
			<input type="number" id="temphot" name="temphot"><br><br>
			<label for="Vol1">Volume 1 (%):</label>
			<input type="number" id="vol1" name="vol1"><br><br>
			<label for="Vol2">Volume 2 (%):</label>
			<input type="number" id="vol2" name="vol2"><br><br>
		</fieldset>
		<fieldset>
			...
			<select type="number" id="psu" name="psu">
			...
			<input type="text" id="genzet1" name="genzet1"><br><br>
			<label for="Vol2">Genzet 2:</label>
			<input type="text" id="genzet2" name="genzet2"><br><br>
			<label for="Vol2">Fuel 1 (%):</label>
			<input type="number" id="fuel1" name="fuel1">
			<br><br>
			<label for="Vol2">Fuel 2 (%):</label>
			<input type="number" id="fuel2" name="fuel2">
			<br><br>
...
$(document).ready(function() {
	...
	<?php if($this->err == 1) { ?>
	alert("Checklist shift already exist, please use the existing one.");
	<?php } ?>
	...
	$( "#template_id" ).change(function() {
		$.ajax({
			url: "/checklistwatertank/getroomsbytemplateid/id/"+$(this).val(),
