            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
				  ...
				  <?php if($this->showWatertankChecklist == 1 ) {  ?> 
					<li id="watertank-menu"><a href="#"><i class="fas fa-tasks"></i> Checklist Water Tank</a>
						<ul class="nav child_menu">
							<?php if($this->showAddWatertankChecklist == 1) { ?>
							<li><a href="/default/checklistwatertank/add">Add Watertank Checklist</a></li>
							<li class="edit-digital-checklist" style="display:none;"><a href="#">Edit Digital Checklist</a></li>						
							<?php } ?>	
							<li><a href="/default/checklistwatertank/view">View Watertank Checklist</a></li>
							<li><a href="/default/checklistwatertank/viewmonthly">Monthly Watertank Checklist</a></li>
						</ul>
					</li>
				  <?php } ?>
