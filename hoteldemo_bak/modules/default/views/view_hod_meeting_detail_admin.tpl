			...
			<form id="hod-form" class="form-label-left" action="" method="POST">
				...
				<div class="x_content">
					...
					<thead>
						...
						<th width="300">Follow Up</th>
						<th rowspan="2" width="50">Done</th>	
						<th rowspan="2" width="70">Done by PIC</th>	
						</tr>
						<tr>
					...
					<table class="table table-striped">
						<tbody>
							...
							<td width="100"><?php echo $topic['category_name'].$this->pic[$topic['category_id']]; ?><br/><a href="/default/hod/exporttopictopdf/id/<?php echo $topic['topic_id']; ?>" target="_blank"><img src="/images/newlogo_pdf.png" width="24"></a></td>
							...
							<td align="center" width="125"><input class="form-control col-md-7 col-xs-12 datepicker" name="finish_date[]" type="text" value="<?php echo $topic['finishdate']; ?>" autocomplete="off" style="width:100px;"></td>
							<td width="300">
					...
					<div class="form-group">
						...
						<?php if($this->approveHODMeeting == 1 && $this->hodMeeting['approved'] != 1) { ?><button id="approve" type="button" class="form-btn" style="width:250px;" >Approve</button><?php } ?>
						</div>
					</div>
				</div>
			</form>
		...
		$('#approve').on('click', function(event){
			...
			if(res == true)
			{
				...
				$.ajax({
					...
					type: 'POST',
					data: { hod_meeting_id: <?php echo $this->hodMeeting['hod_meeting_id']; ?> },
					success: function(response) {
						$("body").mLoading('hide');	
