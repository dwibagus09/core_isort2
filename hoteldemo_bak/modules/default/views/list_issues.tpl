	  ...
	  <div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div id="list-issue-desktop">
			<div id="issue-tabs" class="tabs">
				<nav>
				    <ul class="nav nav-tabs  process-model more-icon-process" role="tablist" id="tabs-aktif">
						<?php if($this->showHousekeepingIssues == 1) { ?>
						  <li role="presentation"><a id="housekeepingicon" href="#housekeeping" aria-controls="housekeeping" role="tab" data-toggle="tab" data-id="2" class="data-tab" ><img src="/images/housekeeping_silver.png" />
						...
						<?php } ?>
						<?php if($this->showEngineeringIssues == 1) { ?>
						  <li role="presentation"><a class="wo" id="engineeringwoicon" href="#engineering_wo" aria-controls="engineering_wo" role="tab" data-toggle="tab" data-id="6" data-wo="1" ><img src="/images/engineering_wo_silver.png" />
				...
				<div class="content">
                  ...
                  <div role="tabpanel" class="tab-pane" id="engineering">
 		  		...
 		  		<div role="tabpanel" class="tab-pane" id="engineering_wo">
		...
		<!-- comment form -->
		  <form id="comment-form" class="mfp-hide white-popup-block"  enctype="multipart/form-data">
			...
			<div id="comments-content" class="three-newest-comments-chat "></div>
		...
		<h1 class="pagetitle">Opened Kaizen</h1>
			...
			Start Date<br/>
			<input type="text" name="wo_startdate" name="startdate" class="datepicker form-control" value="" placeholder="yyyy-mm-dd" autocomplete="off" required> 
			...
			End Date<br/>
			<input type="text" name="wo_enddate" class="datepicker form-control" placeholder="yyyy-mm-dd" autocomplete="off" required>
			...
			Expected Work Time<br/>
			<input type="number" class="form-control" name="expected_work_time" value="" required>
			Hour(s)<br/>
			Worker<br/>
...
$(document).ready(function() {
	...
	$('.nav-tabs li a').click(function() {
		...
		$('.nav-tabs #engineeringwoicon img').attr("src", "/images/engineering_wo_silver.png");
		...
		$.ajax({
		    ...
		    $( "#engineeringwo" ).removeClass( "active" );
	...
	$("#exporttopdf").click(function() {
		var activeTab = document.querySelector('#tabs-aktif .active a');
		var tabId = activeTab.getAttribute('data-id');
		var url = '/default/issue/newexportissuestopdf/id/'+tabId;
		if($('#start_date').val() != "")
		{
		...
		{
			url = url + "/id/" + $('#filter_category_id').val();
		}
