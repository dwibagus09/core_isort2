					...
					<table id="perlengkapan-table" class="table">
						...
						<?php } else { ?>
							...
							<tr>
								...
								<td><?php echo $buildingActiveProtection['location']; ?></td>
								<td><?php echo $buildingActiveProtection['total_item']; ?></td>
								<td><?php echo $buildingActiveProtection['good_condition']; ?></td>
								<td><?php echo $buildingActiveProtection['bad_condition']; ?></td>
								<td><?php echo $buildingActiveProtection['repair_refill_condition']; ?></td>
								<td><?php echo $buildingActiveProtection['new_condition']; ?></td>
								<td><?php echo $buildingActiveProtection['remark']; ?></td>
							</tr>
						<?php } ?>
