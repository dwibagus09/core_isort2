...
class actionControllerBase extends Zend_Controller_Action 
{
	...
	{		
		...
		$config = array('port' 			=> 2500,
			'auth'          => 'login',
			'username' 		=> 'isort@isort.id',
			'password' 		=> 'smtpisort',
		);
		$this->transport = $transport = new Zend_Mail_Transport_Smtp('smtp.isort.id', $config);
		...
		{	
			$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $allowCloseSecurityIssue = $showSafetyIssues = $allowCloseSafetyIssue = $showHousekeepingIssues = $allowCloseHousekeepingIssue = $showParkingIssues = $allowCloseParkingIssue = $showEngineeringIssues = $allowCloseEngineeringIssue = $showBuildingServiceIssues = $allowCloseBuildingServiceIssue = $showTenantRelationIssues = $allowCloseTenantRelationIssue = 0;	
			$showSecurity = $showAddSecurity = $showEditSecurity = $showAddChiefSecurity = $showEditChiefSecurity = $showChiefSecurity = $showSecurityActionPlan = $addSecurityMonthlyAnalysis = $showSecurityMonthlyAnalysis = $addSafetyMonthlyAnalysis = $showSafetyMonthlyAnalysis = $addParkingMonthlyAnalysis = $showParkingMonthlyAnalysis = $addHousekeepingMonthlyAnalysis = $showHousekeepingMonthlyAnalysis = $addEngineeringMonthlyAnalysis = $showEngineeringMonthlyAnalysis = $addBuildingServiceMonthlyAnalysis = $showBuildingServiceMonthlyAnalysis = $addTenantRelationMonthlyAnalysis = $showTenantRelationMonthlyAnalysis = 0;
			...
			$showSecurityPivotChart = $showSafetyPivotChart = $showParkingPivotChart = $showHousekeepingPivotChart = $showEngineeringPivotChart = $showCorporateSecurityPivotChart = $showCorporateSafetyPivotChart = $showCorporateParkingPivotChart = $showCorporateHousekeepingPivotChart = $showCorporateEngineeringPivotChart = $showBuildingServicePivotChart = $showCorporateBuildingServicePivotChart = $showTenantRelationPivotChart = $showCorporateTenantRelationPivotChart = 0;
			...
			$viewFeedbackInbox = 0;	
			$showSafety = $showSafetyActionPlan = 0;
			$showEngineering = $showEngineeringActionPlan = $showEngineeringKpi = 0;
			$showHousekeeping = $showHousekeepingActionPlan = $showHousekeepingKpi = 0;
			$addWorkOrder = $viewWorkOrder = $showStartWO = $showProgressWO = $showFinishWO = $showApprovedWO = 0;
			$showSecurityActionPlanApproval = $showSafetyActionPlanApproval = $showParkingActionPlanApproval = $showHousekeepingActionPlanApproval = $showPreventiveMaintenanceApproval = 0;
			$showDigitalChecklist = $showAddDigitalChecklist = $showAddSpvDigitalChecklist = $showAddHodDigitalChecklist = 0;
			$showWatertankChecklist = $showAddWatertankChecklist = 0;
			$addGCMonthlyAnalysis = $showGcMonthlyAnalysis = $showGcPivotChart = 0;
			
			if(in_array(1, $this->ident['role_ids'])) // Super User
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $allowCloseSecurityIssue = $showSafetyIssues = $allowCloseSafetyIssue = $showHousekeepingIssues = $allowCloseHousekeepingIssue = $showParkingIssues = $allowCloseParkingIssue = $showEngineeringIssues = $allowCloseEngineeringIssue = $showBuildingServiceIssues = $allowCloseBuildingServiceIssue = $showTenantRelationIssues = $allowCloseTenantRelationIssue = 1;
				$showActionPlanSetting = $showActionPlanStat = $showStatistic = $showSiteSelection = 1;
				$showAddSecurity = $showEditSecurity = $showAddChiefSecurity = $showChiefSecurity = $showSecurityActionPlan = $addSecurityMonthlyAnalysis = $showSecurityMonthlyAnalysis = $addSafetyMonthlyAnalysis = $showSafetyMonthlyAnalysis = $addParkingMonthlyAnalysis = $showParkingMonthlyAnalysis = $addHousekeepingMonthlyAnalysis = $showHousekeepingMonthlyAnalysis = $showSecurityPivotChart = $showCorporateSecurityPivotChart = $showSafetyPivotChart = $showCorporateSafetyPivotChart = $showParkingPivotChart = $showCorporateParkingPivotChart = $showHousekeepingPivotChart = $showCorporateHousekeepingPivotChart = 1;
				...
				$viewFeedbackInbox = 1;
				$showEngineering = $showEngineeringActionPlan = $showEngineeringKpi = $showEngineeringPivotChart = $showCorporateEngineeringPivotChart = $addEngineeringMonthlyAnalysis = $showEngineeringMonthlyAnalysis = 1;
				$addBuildingServiceMonthlyAnalysis = $showBuildingServiceMonthlyAnalysis = $showBuildingServicePivotChart = $showCorporateBuildingServicePivotChart = 1;
				$addTenantRelationMonthlyAnalysis = $showTenantRelationMonthlyAnalysis = $showTenantRelationPivotChart = $showCorporateTenantRelationPivotChart = 1;
				$addWorkOrder = $viewWorkOrder = $showStartWO = $showProgressWO = $showFinishWO = $showApprovedWO = 1;
				$showHousekeeping = $showHousekeepingActionPlan = $showHousekeepingKpi = 1;
				$showSecurity = $showSecurityActionPlan = $showSecurityKpi = 1;
				$showParking = $showParkingActionPlan = $showParkingKpi = 1;
				$showSafety = $showSafetyActionPlan = 1;
				$showSecurityActionPlanApproval = $showSafetyActionPlanApproval = $showParkingActionPlanApproval = $showHousekeepingActionPlanApproval = $showPreventiveMaintenanceApproval = 1;
				$showDigitalChecklist = $showAddDigitalChecklist = $showAddSpvDigitalChecklist = $showAddHodDigitalChecklist = 1;
				$showWatertankChecklist = $showAddWatertankChecklist = 1;
				if($this->site_id == 1)
				{
					$addGcMonthlyAnalysis = $showGcMonthlyAnalysis = $showGcPivotChart = 1;
				}
			}
			if(in_array(45, $this->ident['role_ids'])) // Staff Security
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $allowCloseSecurityIssue = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showSecurity = $showAddSecurity = $showEditSecurity = 1;
			}
			...
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $allowCloseSecurityIssue = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showSecurity = $showChiefSecurity = $showAddChiefSecurity = $showSecurityActionPlan = $showSecurityPivotChart = $showSecurityKpi /*= $showCQC = $allowUploadCQC*/ = $addSecurityMonthlyAnalysis = $showSecurityMonthlyAnalysis =  $showHODMeeting = 1;
			}
			if(in_array(4, $this->ident['role_ids'])) // OM
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
				$showSecurity = $showChiefSecurity = $showSafety = $showParkingTraffic = $showHousekeeping = $showOM = $showAddOM = $showEditOM = $showMod = $showAddMod = $showSecurityActionPlan = $showSafetyActionPlan = $showParkingActionPlan = $showHousekeepingActionPlan = $showOMActionPlan = $showActionPlanStat = $showSecurityPivotChart = $showSafetyPivotChart = $showParkingPivotChart = $showHODMeeting = 1;
				$showEngineering = $showEngineeringActionPlan = $showEngineeringKpi = 1;
				$viewWorkOrder = $showApprovedWO = 1;
				$showSecurityActionPlanApproval = $showSafetyActionPlanApproval = $showHousekeepingActionPlanApproval = $showPreventiveMaintenanceApproval = 1;
			}
			if(in_array(5, $this->ident['role_ids'])) // General Manager
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
				$showSecurity = $showChiefSecurity = $showSecurityPivotChart = $showHODMeeting = $approveHODMeeting = $showSafetyComittee = $approveSafetyComittee = 1;
			}
			if(in_array(6, $this->ident['role_ids'])) // Director
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
				$showSecurity = $showChiefSecurity = $showSafety = $showParkingTraffic = $showHousekeeping = $showOM = $showMod = /*$showBM = */$showSecurityActionPlan = $showSafetyActionPlan = $showParkingActionPlan = $showHousekeepingActionPlan = $showStatistic = $showSiteSelection = $showActionPlanStat = $addSecurityMonthlyAnalysis = $showSecurityMonthlyAnalysis = $showCQC = $allowApproveCQC = $showSecurityKpi = $showSafetyKpi = $showParkingKpi =  $showSecurityPivotChart = $showSafetyPivotChart = $showParkingPivotChart =  $showCorporateSecurityPivotChart = $showCorporateSafetyPivotChart = $showCorporateParkingPivotChart = $showSafetyBoard = $uploadSafetyBoard = $showHODMeeting = $showFitOutOnGoing = $showAddHOD = $showAddITMeeting = $showITMeeting = $approveITMeeting = $showSafetyComittee = $showAddSafetyComittee = $approveSafetyComittee = 1;
			}
			if(in_array(7, $this->ident['role_ids'])) // Staff Safety
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSafetyIssues = $allowCloseSafetyIssue = $showSecurityIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showSafety = $showAddSafety = $showEditSafety = $showSafetyActionPlan = $showSafetyPivotChart = $showCQC = $allowUploadCQC = /**/$addSafetyMonthlyAnalysis = $showSafetyMonthlyAnalysis = $showSafetyBoard = $showSafetyMonthlyKpi = 1;
			}
			if(in_array(8, $this->ident['role_ids'])) // Staff Parking & Traffic
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showParkingIssues = $allowCloseParkingIssue = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showParkingTraffic = $showAddParkingTraffic = $showEditParkingTraffic = $showParkingActionPlan = $showParkingPivotChart = /**/$showCQC = $allowUploadCQC = $addParkingMonthlyAnalysis = $showParkingMonthlyAnalysis = $showParkingMonthlyKpi = 1;
			}
			if(in_array(9, $this->ident['role_ids'])) // Staff Housekeeping
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showHousekeepingIssues = $allowCloseHousekeepingIssue = $showSecurityIssues = $showSafetyIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHousekeeping = $showAddHousekeeping = $showEditHousekeeping = $showHousekeepingActionPlan = $showHousekeepingMonthlyKpi = 
				$showAddDigitalChecklist = $showDigitalChecklist = 1;
			}
			if(in_array(10, $this->ident['role_ids'])) // Sales Manager
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $allowCloseHousekeepingIssue = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(11, $this->ident['role_ids'])) // Building Manager
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $allowCloseHousekeepingIssue = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(12, $this->ident['role_ids'])) // Entertainment Manager
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $allowCloseHousekeepingIssue = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(13, $this->ident['role_ids'])) // HOD Security
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $allowCloseSecurityIssue = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showSecurity = $showChiefSecurity = $showSecurityActionPlan = $showSiteSelection = /*$showSecurityKpi = */$allowApproveCQC =  $allowFillChiefRating = $showCQC = $addSecurityMonthlyAnalysis = $showSecurityMonthlyAnalysis = $showCorporateSecurityPivotChart = $showSecurityPivotChart = $showHODMeeting = 1;
			}
			if(in_array(14, $this->ident['role_ids'])) // HOD Safety
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSafetyIssues = $allowCloseSafetyIssue = $showSecurityIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showSafety = $showSafetyActionPlan = $showSiteSelection = $showSafetyKpi = $showSafetyMonthlyKpi = $allowApproveCQC =  $allowFillChiefRating = $showCQC  = $addSafetyMonthlyAnalysis = $showSafetyMonthlyAnalysis = $showSafetyPivotChart =  $showCorporateSafetyPivotChart = $showSafetyBoard = $uploadSafetyBoard = $showHODMeeting = $showCQCEmail = 1;
			}
			if(in_array(15, $this->ident['role_ids'])) // HOD Housekeeping
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showHousekeepingIssues = $allowCloseHousekeepingIssue = $showSecurityIssues = $showSafetyIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = $showCQCEmail = $showHousekeeping = $showAddHousekeeping = $showEditHousekeeping = $showHousekeepingActionPlan = $showHousekeepingMonthlyKpi = $addHousekeepingMonthlyAnalysis = $showHousekeepingMonthlyAnalysis = $showHousekeepingPivotChart = $showAddSpvDigitalChecklist = $showDigitalChecklist = 1;
				if($this->site_id == 1)
				{
					$showEngineering = $showEngineeringActionPlan = $showEngineeringKpi = $showEngineeringPivotChart = $showEngineeringMonthlyAnalysis = 1;
				}			
			}
			if(in_array(16, $this->ident['role_ids'])) // HOD Parking & Traffic
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showParkingIssues = $allowCloseParkingIssue = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showParkingTraffic = $showParkingActionPlan = $showSiteSelection = $showParkingKpi = $showParkingMonthlyKpi = $allowApproveCQC =  $allowFillChiefRating = $showParkingPivotChart = $showCQC = $addParkingMonthlyAnalysis = $showParkingMonthlyAnalysis = $showParkingPivotChart = $showCorporateParkingPivotChart = $showHODMeeting = $showCQCEmail = 1;
			}
			if(in_array(18, $this->ident['role_ids'])) // Chief Building Service
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $addBuildingServiceMonthlyAnalysis = $showBuildingServiceMonthlyAnalysis = $showBuildingServicePivotChart = 1;
			}			
			$showIssueFinding = 1;
			if(in_array(20, $this->ident['role_ids'])) // HRD Manager
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $allowCloseHousekeepingIssue = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(21, $this->ident['role_ids'])) // HOD Engineering
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showEngineeringIssues = $showTenantRelationIssues = $allowCloseEngineeringIssue = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = 1;
				$showEngineering = $showEngineeringActionPlan = $showEngineeringKpi = $showEngineeringPivotChart = $addEngineeringMonthlyAnalysis = $showEngineeringMonthlyAnalysis = 1;
				$addWorkOrder = $viewWorkOrder = $showStartWO = $showProgressWO = $showFinishWO = $showApprovedWO = 1;
				$showHODMeeting = 1;
				
				if($this->site_id == 1)
				{
					$showHousekeeping = $showHousekeepingActionPlan = $showHousekeepingMonthlyKpi = $showHousekeepingMonthlyAnalysis = $showHousekeepingPivotChart = 1;
				}	
			}
			...
			if(in_array(23, $this->ident['role_ids'])) // HOD Fit Out (Untuk Citos, aksesnya sama seperti HOD Parking & Traffic karena FIT OUT menggunakan kategori Parking & Traffic)
			{
				//$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showParkingIssues = $allowCloseParkingIssue = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showParkingTraffic = $showParkingActionPlan = $showSiteSelection = $showParkingKpi = $showParkingMonthlyKpi = $allowApproveCQC =  $allowFillChiefRating = $showParkingPivotChart = $showCQC = $addParkingMonthlyAnalysis = $showParkingMonthlyAnalysis = $showParkingPivotChart = $showCorporateParkingPivotChart = $showHODMeeting = $showCQCEmail = 1;
			}
			if(in_array(24, $this->ident['role_ids'])) // Staff Fit Out
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(25, $this->ident['role_ids'])) // IT
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(26, $this->ident['role_ids'])) // Staff Accounting
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(27, $this->ident['role_ids'])) // Accounting Manager
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(30, $this->ident['role_ids'])) // Admin Operation
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(31, $this->ident['role_ids'])) // Staff Engineering
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showEngineeringIssues = $allowCloseEngineeringIssue = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showTenantRelationIssues = $showEngineering = $showEngineeringActionPlan = $showEngineeringKpi = 1;
				$viewWorkOrder = $showStartWO = $showProgressWO = $showFinishWO = 1;
			}
			if(in_array(32, $this->ident['role_ids'])) // Front Office Manager
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = $addGcMonthlyAnalysis = $showGcMonthlyAnalysis = $showGcPivotChart = 1 ;
			}
			if(in_array(33, $this->ident['role_ids'])) // Front Office Staff
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $addGcMonthlyAnalysis = $showGcMonthlyAnalysis = $showGcPivotChart = 1;
			}
			if(in_array(34, $this->ident['role_ids'])) // Restaurant/Bar Manager
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			...
			if(in_array(36, $this->ident['role_ids'])) // Head Chef
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(37, $this->ident['role_ids'])) // Chef
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(38, $this->ident['role_ids'])) // Chief Steward
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(39, $this->ident['role_ids'])) // Supervisor Steward
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(40, $this->ident['role_ids'])) // Supervisor Housekeeping
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showHousekeepingIssues = $allowCloseHousekeepingIssue = $showSecurityIssues = $showSafetyIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHousekeeping = $showAddHousekeeping = $showEditHousekeeping = $showHousekeepingActionPlan = $showHousekeepingMonthlyKpi = 
				$showAddDigitalChecklist = $showDigitalChecklist = 1;
			}
			if(in_array(41, $this->ident['role_ids'])) // Supervisor Engineering
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showEngineeringIssues = $allowCloseEngineeringIssue = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showTenantRelationIssues = $showEngineering = $showEngineeringActionPlan = $showEngineeringKpi = 1;
				$viewWorkOrder = $showStartWO = $showProgressWO = $showFinishWO = 1;
			}
			if(in_array(42, $this->ident['role_ids'])) // HOD TENANT RELATION
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $addTenantRelationMonthlyAnalysis = $showTenantRelationMonthlyAnalysis = $showTenantRelationPivotChart = $showHODMeeting = 1;
			}
			if(in_array(43, $this->ident['role_ids'])) // HOD General Affair
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(44, $this->ident['role_ids'])) // Restaurant/Bar Staff
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(46, $this->ident['role_ids'])) // HOD IT
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(47, $this->ident['role_ids'])) // HOD Legal
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(48, $this->ident['role_ids'])) // HOD Tax
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(49, $this->ident['role_ids'])) // Staff Entertainment
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(50, $this->ident['role_ids'])) // Staff Casual Leasing
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(51, $this->ident['role_ids'])) // Staff Promosi
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(52, $this->ident['role_ids'])) // Staff Legal
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			if(in_array(53, $this->ident['role_ids'])) // HOD Leasing
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = $showHODMeeting = 1;
			}
			if(in_array(54, $this->ident['role_ids'])) // Staff Leasing
			{
				$showIssueFinding = $showOpenedIssues = $showClosedIssues = $showSecurityIssues = $showSafetyIssues = $showHousekeepingIssues = $showParkingIssues = $showEngineeringIssues = $showTenantRelationIssues = 1;
			}
			...
			if($this->site_id == 2) $showDigitalChecklist = 0;
			
			$this->view->showIssueFinding = $this->showIssueFinding = $showIssueFinding;
			$this->view->showOpenedIssues = $this->showOpenedIssues = $showOpenedIssues;
			$this->view->showClosedIssues = $this->showClosedIssues = $showClosedIssues;
			$this->view->showSecurityIssues = $this->showSecurityIssues = $showSecurityIssues;
			$this->view->allowCloseSecurityIssue = $this->allowCloseSecurityIssue = $allowCloseSecurityIssue;
			$this->view->showSafetyIssues = $this->showSafetyIssues = $showSafetyIssues;
			$this->view->allowCloseSafetyIssue = $this->allowCloseSafetyIssue = $allowCloseSafetyIssue;
			$this->view->showHousekeepingIssues = $this->showHousekeepingIssues = $showHousekeepingIssues;
			$this->view->allowCloseHousekeepingIssue = $this->allowCloseHousekeepingIssue = $allowCloseHousekeepingIssue;
			$this->view->showParkingIssues = $this->showParkingIssues = $showParkingIssues;
			$this->view->allowCloseParkingIssue = $this->allowCloseParkingIssue = $allowCloseParkingIssue;
			$this->view->showEngineeringIssues = $this->showEngineeringIssues = $showEngineeringIssues;
			$this->view->allowCloseEngineeringIssue = $this->allowCloseEngineeringIssue = $allowCloseEngineeringIssue;
			$this->view->showTenantRelationIssues = $this->showTenantRelationIssues = $showTenantRelationIssues;
			$this->view->allowCloseTenantRelationIssue = $this->allowCloseTenantRelationIssue = $allowCloseTenantRelationIssue;
			$this->view->showBuildingServiceIssues = $this->showBuildingServiceIssues = $showBuildingServiceIssues;
			$this->view->allowCloseBuildingServiceIssue = $this->allowCloseBuildingServiceIssue = $allowCloseBuildingServiceIssue;
			...
			$this->view->addSafetyMonthlyAnalysis = $this->addSafetyMonthlyAnalysis = $addSafetyMonthlyAnalysis;
			$this->view->showSafetyMonthlyAnalysis = $this->showSafetyMonthlyAnalysis = $showSafetyMonthlyAnalysis;
			$this->view->addParkingMonthlyAnalysis = $this->addParkingMonthlyAnalysis = $addParkingMonthlyAnalysis;
			$this->view->showParkingMonthlyAnalysis = $this->showParkingMonthlyAnalysis = $showParkingMonthlyAnalysis;
			$this->view->addEngineeringMonthlyAnalysis = $this->addEngineeringMonthlyAnalysis = $addEngineeringMonthlyAnalysis;
			$this->view->showEngineeringMonthlyAnalysis = $this->showEngineeringMonthlyAnalysis = $showEngineeringMonthlyAnalysis;
			$this->view->addHousekeepingMonthlyAnalysis = $this->addHousekeepingMonthlyAnalysis = $addHousekeepingMonthlyAnalysis;
			$this->view->showHousekeepingMonthlyAnalysis = $this->showHousekeepingMonthlyAnalysis = $showHousekeepingMonthlyAnalysis;
			...
			$this->view->showHousekeepingPivotChart =$this->showHousekeepingPivotChart =  $showHousekeepingPivotChart;
			$this->view->showEngineeringPivotChart = $this->showEngineeringPivotChart = $showEngineeringPivotChart;
			...
			$this->view->showCorporateHousekeepingPivotChart =$this->showCorporateParkingPivotChart =  $showCorporateHousekeepingPivotChart;
			$this->view->showCorporateEngineeringPivotChart = $this->showCorporateEngineeringPivotChart = $showCorporateEngineeringPivotChart;
			...
			$this->view->showHousekeeping = $this->showHousekeeping = $showHousekeeping;
			$this->view->showHousekeepingActionPlan = $this->showHousekeepingActionPlan = $showHousekeepingActionPlan;
			$this->view->showHousekeepingKpi = $this->showHousekeepingKpi = $showHousekeepingKpi; 
			$this->view->showSafety = $this->showSafety = $showSafety;
			$this->view->showSafetyActionPlan = $this->showSafetyActionPlan = $showSafetyActionPlan;
			$this->view->showParking = $this->showParking = $showParking;
			$this->view->showParkingActionPlan = $this->showParkingActionPlan = $showParkingActionPlan;
			$this->view->showParkingKpi = $this->showParkingKpi = $showParkingKpi; 
			$this->view->showSecurityActionPlanApproval = $this->showSecurityActionPlanApproval = $showSecurityActionPlanApproval;
			$this->view->showSafetyActionPlanApproval = $this->showSafetyActionPlanApproval	= $showSafetyActionPlanApproval;
			$this->view->showParkingActionPlanApproval = $this->showParkingActionPlanApproval = $showParkingActionPlanApproval;
			$this->view->showHousekeepingActionPlanApproval = $this->showHousekeepingActionPlanApproval = $showHousekeepingActionPlanApproval;
			$this->view->showPreventiveMaintenanceApproval = $this->showPreventiveMaintenanceApproval = $showPreventiveMaintenanceApproval;
			$this->view->showDigitalChecklist = $this->showDigitalChecklist = $showDigitalChecklist;
			$this->view->showWatertankChecklist = $this->showWatertankChecklist = $showWatertankChecklist;
			$this->view->showAddDigitalChecklist = $this->showAddDigitalChecklist = $showAddDigitalChecklist;
			$this->view->showAddSpvDigitalChecklist = $this->showAddSpvDigitalChecklist = $showAddSpvDigitalChecklist;
			$this->view->showAddHodDigitalChecklist = $this->showAddHodDigitalChecklist = $showAddHodDigitalChecklist;
			$this->view->addBuildingServiceMonthlyAnalysis = $this->addBuildingServiceMonthlyAnalysis = $addBuildingServiceMonthlyAnalysis;
			$this->view->showBuildingServiceMonthlyAnalysis = $this->showBuildingServiceMonthlyAnalysis = $showBuildingServiceMonthlyAnalysis;
			$this->view->showBuildingServicePivotChart = $this->showBuildingServicePivotChart = $showBuildingServicePivotChart;
			$this->view->showCorporateBuildingServicePivotChart = $this->showCorporateBuildingServicePivotChart = $showCorporateBuildingServicePivotChart;
			$this->view->addTenantRelationMonthlyAnalysis = $this->addTenantRelationMonthlyAnalysis = $addTenantRelationMonthlyAnalysis;
			$this->view->showTenantRelationMonthlyAnalysis = $this->showTenantRelationMonthlyAnalysis = $showTenantRelationMonthlyAnalysis;
			$this->view->showTenantRelationPivotChart = $this->showTenantRelationPivotChart = $showTenantRelationPivotChart;
			$this->view->showCorporateTenantRelationPivotChart = $this->showCorporateTenantRelationPivotChart = $showCorporateTenantRelationPivotChart;
			$this->view->addGcMonthlyAnalysis = $this->addGcMonthlyAnalysis = $addGcMonthlyAnalysis;
			$this->view->showGcMonthlyAnalysis = $this->showGcMonthlyAnalysis = $showGcMonthlyAnalysis;
			$this->view->showGcPivotChart = $this->showGcPivotChart = $showGcPivotChart;
			$this->view->showWatertankChecklist = $this->showWatertankChecklist = $showWatertankChecklist;
			$this->view->showAddWatertankChecklist = $this->showAddWatertankChecklist = $showAddWatertankChecklist;
		}

		/*** Check hide/show add report button ***/
		if(!empty($this->ident)) {

			if(date("j") <= 15 || in_array(1, $this->ident['role_ids'])) 
			{
				...
				$safetyMonthlyAnalysis = $safetyClass->getSafetyMonthlyAnalysisByMonthYear(date("m"), date("Y"));
				if(!empty($safetyMonthlyAnalysis)) $this->view->hideAddSafetyMonthlyAnalysis = 1;
				else $this->view->hideAddSafetyMonthlyAnalysis = 0;
				
				Zend_Loader::LoadClass('parkingClass', $this->modelDir);
				$parkingClass = new parkingClass();
				$parkingMonthlyAnalysis = $parkingClass->getParkingMonthlyAnalysisByMonthYear(date("m"), date("Y"));
				if(!empty($parkingMonthlyAnalysis)) $this->view->hideAddParkingMonthlyAnalysis = 1;
				else $this->view->hideAddParkingMonthlyAnalysis = 0;
				
				Zend_Loader::LoadClass('housekeepingClass', $this->modelDir);
				$housekeepingClass = new housekeepingClass();
				$housekeepingMonthlyAnalysis = $housekeepingClass->getHousekeepingMonthlyAnalysisByMonthYear(date("m"), date("Y"));
				if(!empty($housekeepingMonthlyAnalysis)) $this->view->hideAddHousekeepingMonthlyAnalysis = 1;
				else $this->view->hideAddHousekeepingMonthlyAnalysis = 0;
				
				Zend_Loader::LoadClass('engineeringClass', $this->modelDir);
				$engineeringClass = new engineeringClass();
				$engineeringMonthlyAnalysis = $engineeringClass->getEngineeringMonthlyAnalysisByMonthYear(date("m"), date("Y"));
				if(!empty($engineeringMonthlyAnalysis)) $this->view->hideAddEngineeringMonthlyAnalysis = 1;
				else $this->view->hideAddEngineeringMonthlyAnalysis = 0;

				Zend_Loader::LoadClass('bsClass', $this->modelDir);
				$bsClass = new bsClass();
				$buildingServiceMonthlyAnalysis = $bsClass->getBuildingServiceMonthlyAnalysisByMonthYear(date("m"), date("Y"));
				if(!empty($buildingServiceMonthlyAnalysis)) $this->view->hideAddBuildingServiceMonthlyAnalysis = 1;
				else $this->view->hideAddBuildingServiceMonthlyAnalysis = 0;
				
				Zend_Loader::LoadClass('trClass', $this->modelDir);
				$trClass = new trClass();
				$tenantRelationMonthlyAnalysis = $trClass->getTenantRelationMonthlyAnalysisByMonthYear(date("m"), date("Y"));
				if(!empty($tenantRelationMonthlyAnalysis)) $this->view->hideAddTenantRelationMonthlyAnalysis = 1;
				else $this->view->hideAddTenantRelationMonthlyAnalysis = 0;
				
				Zend_Loader::LoadClass('gcClass', $this->modelDir);
				$gcClass = new gcClass();
				$gcMonthlyAnalysis = $gcClass->getMonthlyAnalysisByMonthYear(date("m"), date("Y"));
				if(!empty($gcMonthlyAnalysis)) $this->view->hideAddGcMonthlyAnalysis = 1;
				else $this->view->hideAddGcMonthlyAnalysis = 0;
			}
			else {
				$this->view->hideAddSecurityMonthlyAnalysis = 1;
				$this->view->hideAddSafetyMonthlyAnalysis = 1;
				$this->view->hideAddHousekeepingMonthlyAnalysis = 1;
				$this->view->hideAddEngineeringMonthlyAnalysis = 1;
				$this->view->hideAddBuildingServiceMonthlyAnalysis = 1;
				$this->view->hideAddTenantRelationMonthlyAnalysis = 1;
				$this->view->hideAddGcMonthlyAnalysis = 1;
			}
		...
		if((in_array(32, $this->ident['role_ids']) || in_array(33, $this->ident['role_ids'])) && $this->site_id == 1)
		{
			$this->view->kaizenNoPhoto = 1;
		}
		
		if(in_array(1, $this->ident['role_ids']))
		{
			if($this->site_id == 1)	$this->view->kaizenCategories = $category->getCategories(3);
			else $this->view->kaizenCategories = $category->getCategories(6);
		}
		else
		{
			if($this->site_id == 1)	$this->view->kaizenCategories = $category->getCategories(2);
			else  $this->view->kaizenCategories = $category->getCategories(5);
		}
	...
	public function exportchiefsecuritytopdf($id, $site_id = 0, $download = 0) {	
		...
		if(!empty($id))
		{
			...
			if(!empty($equipments)) {
				...
				$pdf->SetTextColor(255,255,255);
				$pdf->SetFont('','B');
				$pdf->Cell(46,7,'Nama','LTR',0,'C',true);
				$pdf->Cell(46,7,'Vendor','LTR',0,'C',true);
				$pdf->Cell(30,7,'Jumlah','LTR',0,'C',true);
				$pdf->Cell(50,7,'Kondisi',1,0,'C',true);
				$pdf->Cell(39,7,'Keterangan','LTR',0,'C',true);
				$pdf->Ln();
				$pdf->Cell(46,7,'Perlengkapan','LRB',0,'C',true);
				$pdf->Cell(46,7,'','LRB',0,'C',true);
				...
				$pdf->SetFont('');
				$pdf->SetTextColor(0,0,0);
				$pdf->SetWidths(array(46, 46, 30, 25, 25, 39));	
				$i = 0;
