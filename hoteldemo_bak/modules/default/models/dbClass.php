...
class checklist_watertank extends Zend_Db_Table_Abstract
{
	protected $_name = 'checklist_watertank';
	protected $_primary = 'checklist_watertank_id';
}

class checklist_comment_watertank extends Zend_Db_Table_Abstract
{
	protected $_name = 'checklist_comment_watertank';
	protected $_primary = 'comment_id';
}
