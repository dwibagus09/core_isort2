...
<div id="pivot-chart">
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
	  	<h2 class="pagetitle">Corporate <?php echo $this->category_name; ?> Business Intelligence</h2>
		...
		<div id="pivot-chart-container">
			...
			<div id="total-each-incident" class="pivot-chart-large" style="height: 500px;">
				<canvas id="totalEachIncident"></canvas>
			</div>
			<div id="total-each-modus" class="pivot-chart-large" style="height: 500px;">
...
$(document).ready(function() {
	...
	$('#issue_type').on('change', function() {
		$.ajax({
			url: '/default/issue/getkejadianbyissuetypesandsites',
	...
	$('#site_id').on('change', function() {
		$.ajax({
			url: '/default/floor/getareasbysiteids',
			data: { site_ids : $(this).val() }
		}).done(function(response) {
			var resp = $.parseJSON(response);
			$("#tenant_umum").empty();
			$.each(resp, function (item, value) {
				$("#tenant_umum").append(new Option(value.area_name, value.area_id));
			});
		});
