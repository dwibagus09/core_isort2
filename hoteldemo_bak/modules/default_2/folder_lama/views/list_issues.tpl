			...
			<div id="issue-tabs" class="tabs">
				<nav>
				    <ul class="nav nav-tabs process-model more-icon-process" role="tablist">
						...
						<?php } ?>
						<?php if($this->showEngineeringIssues == 1) { ?>
						  <li role="presentation"><a id="engineeringicon_wo" href="#engineering" aria-controls="engineering_wo" role="tab" data-toggle="tab" data-id="6"><img src="/images/engineering_silver.png" />
...
$(document).ready(function() {
	...
	$('.nav-tabs li a').click(function() {
		...
		$('.nav-tabs #engineeringicon_wo img').attr("src", "/images/engineering_silver.png");
