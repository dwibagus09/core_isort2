...
<?php 
if(empty($this->housekeeping['report_date'])) $cur_date = date("Y-m-d");
else {
	$cur_report_date = explode(" ",$this->housekeeping['report_date']);
  ...
  <div class="detail-report">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  <div class="x_title">
			<h2 class="pagetitle">Housekeeping Monthly Analytics <?php echo $this->monthYear; ?></h2>
		  ...
		  <div class="x_content">
			...
			<form class="form-horizontal form-label-left" action="/default/housekeeping/savemonthlyanalysis" method="POST" onSubmit="$('body').mLoading();">
