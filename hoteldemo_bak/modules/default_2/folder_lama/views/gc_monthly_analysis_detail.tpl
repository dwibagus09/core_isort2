  ...
  <div class="detail-report">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  <div class="x_title">
			<h2 class="pagetitle">Guest Complain Monthly Analytics <?php echo $this->monthYear; ?> - <?php echo $this->ident['initial']; ?></h2>
			<div class="clearfix"></div>			
			<a href="/default/gc/downloadmonthlyanalysis/id/<?php echo $this->monthly_analysis_id; ?>" target="_blank" style="float:right;"><img src="/images/newlogo_pdf.png" width="24"></a>
			...
			<table id="kesimpulan-table" class="table">
			  ...
			  <tbody>
				...
				<tr>
					...
					<td><?php echo $incident['modus']; ?></td>
					<td><?php echo $incident['total_modus']; ?></td>
