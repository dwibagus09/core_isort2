			...
			<div id="issue-tabs" class="tabs">
				<nav>
				    <ul class="nav nav-tabs process-model more-icon-process" role="tablist">
						...
						<?php } ?>
						<?php if($this->showEngineeringIssues == 1) { ?>
						  <li role="presentation"><a id="engineeringwoicon" href="#engineering_wo" aria-controls="engineering_wo" role="tab" data-toggle="tab" data-id="6"><img src="/images/engineering_silver.png" />
							<p>Engineering WO (<?php echo intval($this->totalEngwoIssues['total']); ?>)</p>
							</a></li>
						<?php } ?>
...
$(document).ready(function() {
    ...
    $( ".nav-tabs li a" ).mouseleave(function() {
		...
		$('.nav-tabs li a #engineeringwo').click(function() {
		$('.add-wo').remove();
	});
	...
	$('.nav-tabs li a').click(function() {
		...
		$.ajax({
			...
			$( "#engineering_wo" ).removeClass( "active" );
