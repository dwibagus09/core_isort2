...
<link rel="stylesheet" href="/css/magnific-popup.css">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle">MOD Report</h2>
			<div class="paging">
		  ...
		  <table class="table table-striped">
			...
			?>
				...
				?>
				<tr>
				  <td class="date-column"><?php echo $mod['day_date']; ?></th>
				  <td class="date-column"><?php echo $mod['name']; ?></td>
				  <td>
						<div class="three-newest-comments" id="comment-<?php echo $mod['mod_report_id']; ?>">
						<?php if(!empty($mod['comments'])) { 
				  ...
				  <td class="action-column">
					<?php if($this->allowEditMod == 1 && $mod['allowEdit'] == 1) { ?><a href="/default/mod/edit/id/<?php echo $mod['mod_report_id']; ?>" class="action-btn"><i class="fa fa-edit" ></i></a><?php } ?>
					<?php /* <a class="action-btn delete"><i class="fa fa-trash" data-id="<?php echo $mod['mod_report_id']; ?>" ></i></a> */ ?>
					<a href="/default/mod/viewdetailreport/id/<?php echo $mod['mod_report_id']; ?>" class="action-btn"><img src="/images/view_report2.jpg" width="24" /></a>
					<a class="add-comment" href="#comment-form" data-id="<?php echo $mod['mod_report_id']; ?>"><img src="/images/comment_24x24.png" /></a>
				  </td>
				</tr>
				<?php
						$i++;
...
$(document).ready(function() {
	...
	/*setInterval(function(){ 
		$.ajax({
			url: "/default/mod/getupdatedcomments",
