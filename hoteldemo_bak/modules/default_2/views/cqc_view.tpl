	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div id="tabs" class="tabs">
			<nav>
				<ul>
					<li id="period1" class="tab" data-id="1"><a href="#period-1"><span>First 6 months</span></a></li>
					<li id="period2" class="tab" data-id="2"><a href="#period-3"><span>Second 6 months</span></a></li>
				</ul>
