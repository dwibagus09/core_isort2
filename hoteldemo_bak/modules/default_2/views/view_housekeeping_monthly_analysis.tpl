...
<link rel="stylesheet" href="/css/magnific-popup.css">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle">Housekeeping Monthly Analytics</h2>
			...
			?>
				...
				<tr>
				  ...
				  <td class="action-column">
				  	<?php if($monthlyAnalysis['allowEdit'] == 1) { ?><a href="/default/housekeeping/addmonthlyanalysis/id/<?php echo $monthlyAnalysis['monthly_analysis_id']; ?>" class="action-btn"><img src="/images/edit_report.png" width="24" /></a><?php } ?>
					<?php /* <a class="action-btn delete"><i class="fa fa-trash" data-id="<?php echo $mod['mod_report_id']; ?>" ></i></a> */ ?>
					<a href="/default/housekeeping/viewdetailmonthlyanalysis/id/<?php echo $monthlyAnalysis['monthly_analysis_id']; ?>" class="action-btn"><img src="/images/view_report.png" width="24" /></a>
