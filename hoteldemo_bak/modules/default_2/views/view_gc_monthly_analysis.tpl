...
<link rel="stylesheet" href="/css/magnific-popup.css">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="pagetitle">Guess Complain Monthly Analytics</h2>
			...
			?>
				...
				<tr>
				  ...
				  <td class="action-column">
				  	<?php if($monthlyAnalysis['allowEdit'] == 1) { ?><a href="/default/gc/addmonthlyanalysis/id/<?php echo $monthlyAnalysis['monthly_analysis_id']; ?>" class="action-btn"><img src="/images/edit_report.png" width="24" /></a><?php } ?>
					<a href="/default/gc/viewdetailmonthlyanalysis/id/<?php echo $monthlyAnalysis['monthly_analysis_id']; ?>" class="action-btn"><img src="/images/view_report.png" width="24" /></a>
