		...
		<div class="x_panel">
			...
			<form id="mom-form" class="form-label-left" action="/default/hod/savedetail" method="POST">
				...
				<div class="x_content">
					...
					<thead>
						<tr>
						<th width="150" rowspan="2">Department</th>
					...
					?>
						...
						<td><?php echo $topic['category_name'].$this->pic[$topic['category_id']]; ?><br/><a href="/default/hod/exporttopictopdf/id/<?php echo $topic['topic_id']; ?>" target="_blank"><img src="/images/newlogo_pdf.png" width="24"></a></td>
						...
						<?php if($this->hodMeeting['approved'] != 1) { ?><td align="center"><?php if(($this->ident['role_id'] == 5 && $topic['category_id'] == $this->userCatId) || $this->ident['role_id'] != 5) { ?><input type="checkbox" id="done_checkbox" name="done_by_pic[<?php echo $i; ?>]" value="1" <?php if($topic['done_by_pic'] == '1') echo "checked"; ?>><input class="form-control col-md-7 col-xs-12" name="topic_id[]" type="hidden" value="<?php echo $topic['topic_id']; ?>"><?php } ?></td><?php } ?>
						</tr>
						<?php
								$i++;
							}
...
$(document).ready(function() {
	...
	$.ajax({
		...
		data: { cur_meeting_date : '<?php echo $this->currentMeetingDate; ?>', id : '<?php echo $this->dept_ids; ?>', hod_meeting_id: '<?php echo $this->hodMeeting['hod_meeting_id']; ?>' }
	}).done(function(response) { 
