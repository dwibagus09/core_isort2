  ...
  <div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
	  <div class="dashboard">
	      <h1 class="page-title">Coordination Meeting</h1>
	      <?php if($this->showAddHOD == 1) { ?>
	       <div class="col-md-2 col-sm-3 col-xs-6">
	            <a href="/default/hod/add">
				<div class="submenu-icon">
				    <img src="/images/add_report.png" /><div class="submenu-icon-title">Add Coordination Meeting MOM</div>
				</div>
				</a>
			</div>		
			<?php } ?>
	       <div class="col-md-2 col-sm-3 col-xs-6">
				...
				<div class="submenu-icon">
				    <img src="/images/spv_report.png" /><div class="submenu-icon-title">View Coordination Meeting MOM</div>
				</div>
				</a>
			</div>
