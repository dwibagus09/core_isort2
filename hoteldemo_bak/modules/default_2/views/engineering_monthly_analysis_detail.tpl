  ...
  <div class="detail-report">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  <div class="x_title">
			<h2 class="pagetitle">Engineering Monthly Analytics <?php echo $this->monthYear; ?> - <?php echo $this->ident['initial']; ?></h2>
			<div class="clearfix"></div>			
			<a href="/default/engineering/downloadengineeringmonthlyanalysis/id/<?php echo $this->monthly_analysis_id; ?>" target="_blank" style="float:right;"><img src="/images/newlogo_pdf.png" width="24"></a>
