	...
	<div class="meeting-table">
		...
		<table class="table table-striped">
			<tbody>
				...
				?>
				<tr>
				<td width="200" align="center"><?php echo $issue['category_name'].$this->pic[$issue['category_id']]; ?></td>
				...
				<td width="175"><?php echo $issue['location']; ?></td>
				<td width="120"><?php echo $issue['date']; ?></td>
				<td width="220"><div class="three-newest-comments" id="comment-<?php echo $issue['issue_id']; ?>">
