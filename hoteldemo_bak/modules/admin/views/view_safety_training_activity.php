...
<div id="content">
	<div class="outer">
		<div class="inner bg-light lter">
			<div class="col-lg-12">
				<a href="#training-form" id="add-training" class="add-btn" style="width:150px; float:right;">
				  <i class="fa fa-plus-square "></i>
				  <span class="link-title">Add Activity</span>
				</a>
				<h3 class="page-title">Safety Training Activity</h3>
...
$(document).ready(function() {
	...
	$('.edit-training').magnificPopup({
		...
		callbacks: {
			open: function() {
				var id = selectedID;
				$.ajax({
					url: "/admin/training/getsafetytrainingactivitybyid",
					data: { id : id }
	...
	$('#training-form').on('submit', function(event){
		...
		$.ajax({
			url: '/admin/training/addsafetytrainingactivity',
			type: 'POST',
			data: $(this).serialize(),
			success: function(id) {
				 location.href="/admin/training/viewsafetytrainingactivity";
			}
		});
	});
	...
	$('.delete-training').click(function() {
		...
		{
			$.ajax({
				url: "/admin/training/deletesafetytrainingactivity",
