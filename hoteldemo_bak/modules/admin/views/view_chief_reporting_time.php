...
<div id="content">
	<div class="outer">
		<div class="inner bg-light lter">
			<div class="col-lg-12">
				<h3 class="page-title">Chief Security Reporting Time</h3>
				<br/>
				 <form action="/admin/setting/saveothersetting" id="equipment-form">
					...
					<label for="chief_security_reporting_time">Chief Security Reporting Time</label><br/>
					<input type="text" class="form-control" name="chief_security_reporting_time" id="chief_security_reporting_time" value="<?php echo $this->setting['chief_security_reporting_time']; ?>">
					<br/>
