	...
	<div class="outer">
		<div class="inner bg-light lter">
			<div class="col-lg-12">
				...
				<h3 class="page-title">Security Training Activity</h3>
...
$(document).ready(function() {
	...
	$('.edit-training').magnificPopup({
		...
		callbacks: {
			open: function() {
				var id = selectedID;
				$.ajax({
					url: "/admin/training/getsecuritytrainingactivitybyid",
					data: { id : id }
	...
	$('#training-form').on('submit', function(event){
		...
		$.ajax({
			url: '/admin/training/addsecuritytrainingactivity',
			type: 'POST',
			data: $(this).serialize(),
			success: function(id) {
				 location.href="/admin/training/viewsecuritytrainingactivity";
			}
		});
	});
	...
	$('.delete-training').click(function() {
		...
		{
			$.ajax({
				url: "/admin/training/deletesecuritytrainingactivity",
