			...
			<div class="col-lg-12">
				...
				<br/>
				 <form action="/admin/setting/saveothersetting" id="equipment-form">
					...
					<label for="housekeeping_reporting_time">Housekeeping Reporting Time</label><br/>
					<input type="text" class="form-control" name="housekeeping_reporting_time" id="housekeeping_reporting_time" value="<?php echo $this->setting['housekeeping_reporting_time']; ?>">
					<br/>
