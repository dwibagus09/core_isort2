...
<div class="page-header">
    ...
    <!--<button class="btn btn-primary mt-3" id="addAreaButton">Add Area</button>-->
     <div class="ms-auto"> <!-- Menempatkan tombol di sisi kanan -->
                                    <button class="btn btn-primary me-2" id="addIncidentButton">Add Item</button>
                                    <button class="btn btn-danger" id="delete-selected">Delete Item</button>
                                </div>
</div>
<!-- PAGE-HEADER END -->
            ...
            <div class="modal-body">
                <form id="addIncidentForm">
                    ...
                    <!--</div>-->
                      ...
                      <div class="mb-3">
                        <label for="area_name" class="form-label">Item Name</label>
        ...
        <div class="modal-content">
            ...
            <form id="editIncidentForm">
                ...
                <div class="modal-body">
                    ...
                    <!--</div>-->
                     <div class="mb-3">
                        <label for="area_name_edit" class="form-label">Item Name</label>
...
<script>
    ...
    function fetchIncident(departmentId) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#incident-name').text(data.department_name + ' Item');
    ...
    $(document).ready(function() {
        ...
        $('#editIncidentForm').on('submit', function(e) {
            e.preventDefault();
            var formData = new FormData(this);
            var departmentId = $('#editIncidentForm').data('id');

            $.ajax({
                url: '/incident/' + departmentId,
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
