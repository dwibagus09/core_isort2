...
@section('content')
                            ...
                            <div class="page-header">
                                ...
                                <!--</ol>-->
                                <button class="btn btn-primary mt-3" id="addUserButton"><i class="fe fe-plus"></i> Add User</button>
                            </div>
                            <!-- PAGE-HEADER END -->
                                    ...
                                    <div class="card">
                                        <div class="">
                                            <div class="grid-margin">
                                                <div class="">
                                                     <button id="delete-selected" class="btn btn-danger btn-sm text-end" style="display: none;">Delete Selected</button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="addUserForm">
                                            ...
                                            <div class="mb-3">
                                                <label for="username" class="form-label">Phone/Whatsapp</label>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="editUserForm">
                                            ...
                                            <div class="mb-3">
                                                <label for="username" class="form-label">Email</label>
                                                <input type="text" class="form-control" id="nama_edit" name="email" >
                                            </div>
                                            <div class="mb-3">
                                                <label for="username" class="form-label">Phone/Whatsapp</label>
                                                <input type="text" class="form-control" id="nope_edit" name="nope" >
                                            </div>
                                            <div class="mb-3">
                                                <label for="role" class="form-label">Role</label>
...
<script>
    ...
    $(document).on('click', '.edit-user-btn', function() {
        ...
        $.ajax({
            url: '/user/' + userId + '/edit', // Endpoint untuk mengambil data
            type: 'GET',
            success: function(response) {
    ...
    $('#editUserForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '/user/' + userId, // Endpoint update
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $('#delete-selected').click(function () {
        ...
        $.ajax({
            url: '{{ route("users.delete") }}', // Pastikan route delete ini sudah benar
            type: 'POST',
            data: {
                ids: selectedIds,
